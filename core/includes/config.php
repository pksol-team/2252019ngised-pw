...
class lumise_cfg extends lumise_tmpl_register{
    ...
    public $settings = array(
		...
		'report_bugs' => 2,
		'email_design' => 1,
		'components' => array('shop', 'product', 'templates', 'cliparts', 'text', 'design_text', 'uploads', 'shapes', 'drawing', 'layers', 'back'),
		'disable_resources' => '',
		'min_upload' => '',
		'max_upload' => '',
		'dis_qrcode' => '',
    ...
    public function init() {
		...
		if ($lumise->cfg->settings['components'] === null) {
			$lumise->cfg->settings['components'] = array('product', 'templates', 'cliparts', 'text', 'design_text', 'uploads', 'layers');
